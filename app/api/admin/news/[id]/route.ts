  ...
  try {
    ...
    const sourceName =
      typeof body.sourceName === "string"
        ...
        : existingNews.sourceName;

    const sourceUrl =
      typeof body.sourceUrl === "string"
        ? body.sourceUrl.trim()
        : existingNews.sourceUrl;
    ...
    const language =
      body.language === "EN" || body.language === "HI"
        ? body.language
        : existingNews.language;
    ...
    return NextResponse.json(
      {
        success: false,
        message: "News update करने में समस्या हुई।"
      },
      { status: 500 }
    );
  }
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        message: "News delete करने में समस्या हुई।"
      },
      { status: 500 }
    );
  }
